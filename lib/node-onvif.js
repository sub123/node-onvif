...
Onvif.prototype.scanDevices = function(callback){
	let promise = new Promise((resolve, reject) => {
		var os = require('os');
		...
		const OnvifServiceDevice = require('./lib/service-device.js');
		addrs.forEach(function(addr){
			...
			block.forEach( (ip, long, index) => {
				...
				ports.forEach(function(port){
					...
					onvfd.getSystemDateAndTime((error, result) => {
